...
A multi-agent marketing research system that routes your questions to 9 specialist AI agents — running entirely on your own hardware via **Ollama** or **LM Studio**. No cloud, no API keys, no cost per token.
